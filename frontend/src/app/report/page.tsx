...
function SectionTitle({ children }: { children: React.ReactNode }) {
  return (
    <h2 className="text-2xl font-bold text-gray-800 mt-12 mb-4 pb-2 border-b-2 border-blue-200">
      {children}
    </h2>
  );
}
...
export default function ReportPage() {
  return (
    <div className="max-w-5xl mx-auto">
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 rounded-xl p-8 mb-8 text-white">
        <h1 className="text-3xl font-bold mb-2">OCRCheck 可行性調査報告書</h1>
        <p className="text-blue-100 text-lg">
          書類スキャン・OCR・AI管理システム POC
        </p>
        <div className="flex gap-6 mt-4 text-sm text-blue-200">
          <span>作成日: 2026年2月9日</span>
          <span>ステータス: <Badge color="green">POC検討段階</Badge></span>
        </div>
      </div>

      {/* TOC */}
      <div className="bg-white rounded-lg border border-gray-200 p-6 mb-8">
        <h3 className="font-bold text-gray-700 mb-3">目次</h3>
        <ol className="list-decimal list-inside space-y-1 text-sm text-blue-600">
          <li><a href="#overview" className="hover:underline">プロジェクト概要</a></li>
          <li><a href="#tech-survey" className="hover:underline">技術調査: OCRモデルの精度比較</a></li>
          <li><a href="#architecture" className="hover:underline">システムアーキテクチャ</a></li>
          <li><a href="#implementation" className="hover:underline">各要件の実現方法</a></li>
          <li><a href="#poc-plan" className="hover:underline">POC実施計画</a></li>
          <li><a href="#cost" className="hover:underline">コスト概算</a></li>
          <li><a href="#risk" className="hover:underline">リスクと対策</a></li>
          <li><a href="#conclusion" className="hover:underline">結論・推奨</a></li>
        </ol>
      </div>

      {/* 1. Overview */}
      <SectionTitle>
        <span id="overview">1. プロジェクト概要</span>
      </SectionTitle>
      ...
      {/* 2. Tech Survey */}
      <SectionTitle>
        <span id="tech-survey">2. 技術調査: OCRモデルの精度比較</span>
      </SectionTitle>
  ...
  + Vision LLM (文書理解・構造化・分類)`}</CodeBlock>
      ...
      {/* 3. Architecture */}
      <SectionTitle>
        <span id="architecture">3. システムアーキテクチャ</span>
      </SectionTitle>
      ...
      {/* 4. Implementation */}
      <SectionTitle>
        <span id="implementation">4. 各要件の実現方法</span>
      </SectionTitle>
      ...
      {/* 5. POC Plan */}
      <SectionTitle>
        <span id="poc-plan">5. POC実施計画</span>
      </SectionTitle>
...
コンテナ:       Docker + Docker Compose (ローカル開発)`}</CodeBlock>
      ...
      {/* 8. Conclusion */}
      <SectionTitle>
        <span id="conclusion">8. 結論・推奨</span>
      </SectionTitle>
